  ...
  return (
    <section className="container mx-auto h-full px-2">
      <div className="w-full min-h-screen py-10 flex flex-col md:flex-row  gap-4  justify-center">
            ...
            <Box bg="#2E8B57" shadow={"2xl"} p={8} color="white" w={"90%"}>
              ...
              >
                ...
                <div className="w-full flex items-center justify-center gap-2">
                  ...
                  <p>
                    {Number(employee.availableForWithdrawal).toLocaleString(
                      "pt-br",
                      {
                        style: "currency",
                        currency: "BRL",
        ...
        {dvl_employee && dvl_employee.length > 0 ? (
          <TableContainer width={"100%"}>
            <h1 className="w-full text-left text-xl py-4 text-gray-400">
              Comissão Revistas
            </h1>
            <Table variant="simple">
              <TableCaption>Comissões á receber</TableCaption>
          ...
          <div className="w-full -full flex items-center justify-center">
            <p className="text-gray-300">Nenhuma comissão á receber !</p>
          </div>
        )}
      </div>
    </section>
